        ...
        <div className="w-full max-w-lg text-center md:text-left">
          ...
          >
            <h1 className="text-2xl sm:text-3xl font-bold text-stone-800 font-poppins leading-snug mb-2">
              <Typewriter words={["Norah Haque"]} loop={1} typeSpeed={100} />
            </h1>
            <p className="text-sm text-stone-700 font-poppins text-center md:text-left mx-3 md:mx-0">
              ...
              Science & Management! What has always driven me is building tech
              that really matters to me, with a focus on full-stack development.
              Outside of code, you&apos;ll find me drinking coffee, out on a run
              outside, or deep in a book!
            </p>
          </motion.div>
