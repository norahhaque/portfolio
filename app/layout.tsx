...
export const metadata: Metadata = {
  ...
  description:
    "Norah is a Computer Science student at the University of Minnesota interested in data engineering, backend systems, and applied software development.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        className={`${inter.className} ${poppins.variable} bg-white text-gray-950`}
      >
